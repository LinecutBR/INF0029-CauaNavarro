...
void getTeacher(Teacher vetor[]) {
  ...
  for (x = 0; x < LEN_TEACHER; x++) {
    if (vetor[x].status == 1) {
      ...
      printf("Nome: %s\n", vetor[x].name);
      printf("Sexo: %c\n", vetor[x].sex);
      printf("Matricula: %d\n", vetor[x].registration);
      printf("Data de Nascimento: %d/%d/%d\n", vetor[x].dateOfBirth[0],
             vetor[x].dateOfBirth[1], vetor[x].dateOfBirth[2]);
      printf("CPF: %s\n", vetor[x].cpf);
      if (vetor[x].status == 1) {
        printf("Status: Ativo\n");
      } else
...
void deleteTeacher(Teacher vetor[]) {
  int option = 2;
  while (option != 0) {
    int x = 0;
    int not_found = 1;
    ...
    scanf("%d", &matricula);
    for (x = 0; x < LEN_TEACHER; x++) {
      if (vetor[x].registration == matricula && vetor[x].status == 1) {
        vetor[x].status = 0;
        not_found = 0;
...
void RegisterTeacher(Teacher vetor[], int vetor2[],int cont) {
  ...
  while (option != 1) {
    ...
    printf("-----------------------------------\n");
    printf("Matricula: ");
    scanf("%d", &vetor[cont].registration);
    getchar();
    printf("Nome do Professor: ");
    fgets(vetor[cont].name, 50, stdin);
    printf("Sexo: ");
    scanf("%c", &vetor[cont].sex);
    getchar();
    printf("Data de Nascimento>>>\n");
    printf("Dia: ");
    scanf("%d", &vetor[cont].dateOfBirth[0]);
    getchar();
    vetor2[cont] = vetor[cont].dateOfBirth[0];
    printf("Mês: ");
    scanf("%d", &vetor[cont].dateOfBirth[1]);
    getchar();
    vetor2[cont] = vetor2[cont] + vetor[cont].dateOfBirth[1] * 100;
    printf("Ano: ");
    scanf("%d", &vetor[cont].dateOfBirth[2]);
    getchar();
    vetor2[cont] = vetor2[cont] + vetor[cont].dateOfBirth[2] * 10000;
    vetor[cont].date = vetor2[cont];
    printf("CPF: ");
    fgets(vetor[cont].cpf, 15, stdin);
    vetor[cont].status = 1;
    cont++;
...
void Teachers() {
    ...
    case 0:
      ...
      // CHECK
    case 1:
      getTeacher(teachersList);
      break;
    // CHECK
    case 2:
      RegisterTeacher(teachersList, days, cont_t);
      break;
    // CHECK
    case 3:
      deleteTeacher(teachersList);
      break;
  	//check
    case 4:
